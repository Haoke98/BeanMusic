...
public class VideoViewHolder extends RecyclerView.ViewHolder {
    ...
    public VideoViewHolder(@NonNull View itemView) {
        super(itemView);
        likeCountView = itemView.findViewById(R.id.textview_likeCount_fragmentcomposition);
        videoCover = itemView.findViewById(R.id.imageView_videocover);
...
//        mainActivity = itemView.getContext();
    ...
    public void bind(Video video) {
        ...
        Bitmap cover = video.getCover();
        if (videoCover == null) {
            cover = video.getVideoThumb();
        }
